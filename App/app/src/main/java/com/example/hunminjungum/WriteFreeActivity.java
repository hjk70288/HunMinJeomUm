...
public class WriteFreeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(WriteFreeActivity.this);
                                builder.setMessage("게시글 작성을 완료하였습니다.")
                                        .setPositiveButton("ok", null)
                                        .create()
                                        .show();
                                Intent intent = new Intent(WriteFreeActivity.this, CommunityActivity.class);
                ...
                WriteFreeRequest writeFreeRequest = new WriteFreeRequest(title, content, session_id, responseListener);
                RequestQueue queue = Volley.newRequestQueue(WriteFreeActivity.this);
                queue.add(writeFreeRequest);
            }
        });
