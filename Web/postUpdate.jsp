<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="domain.*, persistence.*"%>
...
<!-- 글 수정 -->
   ...
   <!-- Board-->
     <div style="margin-top:25px" class="col-lg-9">
     	<h2 class="text-black mt-0">글 수정</h2>
     	<form action="PostServlet?cmd=updatePost&postnum=<%=postVO.getPostNum()%>&boardId=<%=postVO.getBoardId() %>" method="post">
     	<div class="containter">
     	<div class="form-group">
     		<input type="text" class="form-control" id="title" name="title" value= <%=postVO.getTitle() %>>
     	</div>
     	<div class="form-group">
     		<textarea class="form-control" id="content" name="content" rows="20"><%=postVO.getContent() %></textarea>
     	</div>
